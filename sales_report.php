                                            ...
                                            <thead>
                                                ...
                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td>
                                                            <a href="inc.process/view_sales_details.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info "><i class="fas fa-eye"></i></button></a>
                                                        ...
                                                        <?php
                                                        if($user_id == 0){
                                                            echo '<td><a href="inc.process/view_sales_details.php?id='.$row['id'].'"><button type="button" class="btn btn-info"><i class="fas fa-eye"></i></button></a></td>';
                                                            echo '<td><a href="inc.process/edit_sales_report_process.php?id='.$row['id'].'"><button type="button" class="btn btn-success"><i class="fas fa-edit"></i></button></a></td>';
                                                            echo '<td><a href="inc.process/delete_sales_report.php?id='.$row['id'].'"><button type="button" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button></a></td>';
                                                        }else{
                                                            echo '<td><a href="inc.process/view_sales_details.php?id='.$row['id'].'"><button type="button" class="btn btn-info"><i class="fas fa-eye"></i></button></a></td>';
                                                        }
                                                        ?> 
